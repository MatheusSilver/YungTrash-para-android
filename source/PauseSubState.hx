...
class PauseSubState extends MusicBeatSubstate
{
	...
	var menuItemsOG:Array<String> = ['Continuar', 'Reiniciar', 'Mudar Dificuldade', 'Modo de treino', 'Botplay', 'Voltar ao menu'];
	...
	public function new(x:Float, y:Float)
	{
		...
		practiceText = new FlxText(20, 15 + 101, 0, "MODO TREINO", 32);
