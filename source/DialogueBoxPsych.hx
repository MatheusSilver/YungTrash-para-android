...
class DialogueBoxPsych extends FlxSpriteGroup
{
	...
	function addCharacter(char:FlxSprite, name:String) {
		switch(name) {
			...
			case 'gemaplys':
				char.frames = Paths.getSparrowAtlas('dialogue/Gemaplys_Dialogue'); //oppa gangnam style xddddd kill me
				char.animation.addByPrefix('talkIdle', 'parado', 24, true);
				char.animation.addByPrefix('talk', 'falando', 24, true);
            
			case 'yunglixo':
				char.frames = Paths.getSparrowAtlas('dialogue/Yunglixo_Dialogue'); //oppa gangnam style xddddd kill me
				char.animation.addByPrefix('talkIdle', 'yunglixoparado', 24, true);
				char.animation.addByPrefix('talk', 'yunglixofalando', 24, true);
		}
